 ...
 * @author throwable
 * @version v1.0
 * @description copy from {@link org.apache.curator.framework.recipes.locks.LockInternals}
 * @since 2017/5/17 22:35
 */
public class ZookeeperLockInternals {
	...
	ZookeeperLockInternals(CuratorFramework client, LockInternalsDriver driver, String path, String lockName, int maxLeases) {
		this.driver = driver;
