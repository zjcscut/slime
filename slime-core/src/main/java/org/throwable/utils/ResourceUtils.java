...
public final class ResourceUtils {
	...
	public static Resource[] getResourcesByPathPattern(String pathPattern) {
		...
		try {
			...
			log.error(String.format("get resources from path:[%s] failed", pathPattern), e);
		}
		return resources;
	}
	...
	public static Resource getResourcesByLocation(String location) {
		...
		try {
			...
			log.error(String.format("get resources from location:[%s] failed", location), e);
		}
		return resource;
	}
	...
	public static String getPropValueByLocation(String location, String key) {
		...
		if (resource != null) {
			try {
				...
				log.error(String.format("get resource value from properties file location:[%s] failed", location), e);
			}
		}
		return value;
	}
	...
	public static List<String> getPropValuesByPathPattern(String pathPattern, String key) {
		...
		for (Resource resource : resources) {
			try {
				...
				log.error(String.format("get resource values from properties file pathPattern:[%s] failed", pathPattern), e);
			}
		}
		return values;
	}
	...
	public static String getYamlValueByLocation(String location, String key) {
		...
		if (resource != null) {
			try {
				...
				log.error(String.format("get resource value from yaml file location:[%s] failed", location), e);
			}
		}
		return value;
	}
	...
	public static List<String> getYamlValuesByPathPattern(String pathPattern, String key) {
		...
		for (Resource resource : resources) {
			try {
				...
				log.error(String.format("get resource values from yaml file pathPattern:[%s] failed", pathPattern), e);
			}
		}
		return values;
	}
