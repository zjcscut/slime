 ...
 */
@Slf4j
public class RedissonLockAspectRegistrar implements ImportBeanDefinitionRegistrar, EnvironmentAware {
    ...
    public void setEnvironment(Environment environment) {
        this.location = environment.getProperty(RedissonLockProperties.PREFIX + ".location");
    }
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata,
        ...
        registerRedissonLockFactory(beanFactory);
        registerRedissonLockTemplate(beanFactory);
    ...
    private void registerRedissonLockFactory(DefaultListableBeanFactory beanFactory) {
        RedissonLockFactory redissonLockFactory = new RedissonLockFactory(location);
        beanFactory.registerSingleton("redissonLockFactory", redissonLockFactory);
    }

    private void registerRedissonLockTemplate(DefaultListableBeanFactory beanFactory) {
        RedissonLockFactory redissonLockFactory = beanFactory.getBean(RedissonLockFactory.class);
        RedissonLockTemplate redissonLockTemplate = new RedissonLockTemplate(redissonLockFactory);
        beanFactory.registerSingleton("redissonLockTemplate", redissonLockTemplate);
    }
